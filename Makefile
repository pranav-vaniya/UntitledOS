...
build:
	...
	$(LD) -T linker.ld -o build/UntitledOS/boot/kernel build/boot.o build/kernel.o build/vga.o build/gdt.o build/gdts.o build/util.o build/idt.o build/idts.o build/timer.o build/keyboard.o build/stdio.o build/memory.o
